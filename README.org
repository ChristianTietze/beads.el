...
[[https://codeberg.org/ctietze/beads.el][https://img.shields.io/badge/Codeberg-Repository-2185D0?logo=codeberg&logoColor=white]]
...
/(Screenshots use [[https://protesilaos.com/emacs/modus-themes][modus-themes]])/

** Issue List

Browse issues in a sortable, filterable table. Press =P= to toggle preview mode.

[[file:screenshots/beads-list.png]]

** Preview Mode

Navigate issues with live preview in a side window:

[[file:screenshots/beads-preview-mode-demo.webm]]

([[file:screenshots/beads-preview-mode-demo.webm][Open video]] if playback controls are missing)

** Issue Details

View full issue details including description, design notes, and metadata:

[[file:screenshots/beads-details.png]]
...
[[file:screenshots/beads-edit-description.png]]

Or use the form editor (=E=) to edit all fields at once:

[[file:screenshots/beads-edit-widgets.png]]
